...
declare apps_kde="plasma-desktop sddm elogind kcron ark spectacle xdg-desktop-portal-kde pinentry-qt plasma-applet-active-window-control kde-gtk-config5 breeze-gtk kscreen plasma-nm plasma-pa pcmanfm-qt upower xdg-user-dirs-gtk okular"
